...
public class Edit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        scroll.setBounds(0, 0, 860, 420);

        b1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        b1.setForeground(new java.awt.Color(0, 0, 255));
        b1.setText("View");
        b1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(255, 255, 255), new java.awt.Color(255, 255, 255), new java.awt.Color(255, 255, 255), new java.awt.Color(255, 255, 255)));
        b1.setOpaque(false);
        ...
        b2.setBounds(30, 440, 85, 36);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/electricity_billing/p3.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-100, 0, 960, 530);
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        int row=table.getSelectedRow();
           ...
           Edit_Operator e=new Edit_Operator(ID, name1, name2,pass, email);
           e.setSize(725, 550);
           e.setLocation(650, 250);
           e.setVisible(true);
           this.dispose();
        }catch(Exception e){
